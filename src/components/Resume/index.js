...
function Resume() {
    return (
      ...
      <iframe className="resume"src="https://drive.google.com/file/d/1-ZegopvruWZmehaEpN_t3XeD2MAwTG4_/view?usp=sharing" width="900" height="600" allow="autoplay"></iframe>
